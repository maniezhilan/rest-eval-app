...
$stateProvider.state('login', {
  ...
  .state('responses.list', {
    ...
    url: '/new',
    templateUrl: '/responses/add.html',
    controller: 'ResponseCreateController',

    }).state('responses.edit', {
    url: '/:id/edit',
    templateUrl: 'responses/update.html',
    controller: 'ResponseEditController',

        })

        // End Routes for responses
  ...
  .state('questions.list', {
    ...
    url: '/:id/edit',
    templateUrl: 'questions/update.html',
  ...
  .state('surveys.list', {
    ...
    url: '/new',
    templateUrl: '/surveys/add.html',
    controller: 'SurveyCreateController',

    }).state('surveys.edit', {
    url: '/:id/edit',
    templateUrl: 'surveys/update.html',
    controller: 'SurveyEditController',

        })

        // End Routes for surveys
